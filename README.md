...
running command...
$ aio (--version|-v)
@adobe/aio-cli/11.1.4 darwin-arm64 node-v24.11.1
$ aio --help [COMMAND]
USAGE
  $ aio COMMAND
...
...
_See code: [src/commands/discover.ts](https://github.com/adobe/aio-cli/blob/11.1.4/src/commands/discover.ts)_
...
_See code: [src/commands/rollback.ts](https://github.com/adobe/aio-cli/blob/11.1.4/src/commands/rollback.ts)_
...
_See code: [src/commands/update.ts](https://github.com/adobe/aio-cli/blob/11.1.4/src/commands/update.ts)_
